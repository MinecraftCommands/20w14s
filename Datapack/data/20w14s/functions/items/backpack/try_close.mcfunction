...
execute store result score implode temp if data entity @e[type=chest_minecart,tag=20w14s.my_backpack_minecart,limit=1,sort=nearest] Items[{id:"minecraft:command_block",tag:{20w14s:{opened:1b}}}]
