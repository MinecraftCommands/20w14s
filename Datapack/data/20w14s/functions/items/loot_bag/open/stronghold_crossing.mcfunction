#> 20w14s:items/loot_bag/open/stronghold_crossing
...
execute if entity @e[type=minecraft:item, distance=..0.1, nbt={Item: {id: "minecraft:enchanted_book"}}] run function 20w14s:items/loot_bag/open/_sparkles
