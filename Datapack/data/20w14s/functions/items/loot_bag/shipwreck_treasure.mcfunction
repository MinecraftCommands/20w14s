#> 20w14s:items/loot_bag/shipwreck_treasure
...
execute if entity @e[type=minecraft:item, distance=..0.1, nbt={Item: {id: "minecraft:experience_bottle"}}] run function 20w14s:items/loot_bag/_sparkles
