...
execute if score $mainhand temp matches 1 run replaceitem entity @s weapon.mainhand air
...
execute if score $mainhand temp matches 0 run replaceitem entity @s weapon.offhand air
