...
execute if score 20w14s.end_boss_tick global matches 820 run tp 00000000-0000-0001-0000-0000000b2797 61.83 103.40 400563.23 -244.15 -14.68
...
execute if score 20w14s.end_boss_tick global matches 823 run tp 00000000-0000-0001-0000-0000000b2797 61.90 103.64 400562.97 -249.87 -15.44
execute if score 20w14s.end_boss_tick global matches 823 run effect give @a[tag=20w14s.fighting_sun] levitation 50 10 true
execute if score 20w14s.end_boss_tick global matches 823 run execute as @a[tag=20w14s.fighting_sun] at @s facing 57 ~ 400563 run tp @s ^ ^ ^0.5
...
execute if score 20w14s.end_boss_tick global matches 826 run tp 00000000-0000-0001-0000-0000000b2797 61.93 103.95 400562.67 -257.20 -16.36
