...
execute if score 20w14s.end_boss_tick global matches 969 run data modify entity 00000000-0000-0001-0000-0000000b2797 ArmorItems[3].tag.CustomModelData set value 9
