...
# If non-dying dragon, make sure active loop is running
execute if entity 00000000-0000-0004-0000-0000000b2797 run schedule function 20w14s:mobs/dragon/loop_active 3t