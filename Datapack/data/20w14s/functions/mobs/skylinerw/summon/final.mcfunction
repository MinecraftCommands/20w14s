...
summon minecraft:endermite ~ ~ ~ {Silent:1b,PersistenceRequired:true,Tags:["20w14s.custom", "20w14s.skylinerw.endermite"],CustomName:'{"text":"Skylinerw"}',Invulnerable:true,ActiveEffects:[{Id:14b,Duration:2147483647,ShowParticles:false}],Passengers:[{id:"minecart",Tags:["20w14s.custom", "20w14s.skylinerw.minecart"],Invulnerable:true,CustomDisplayTile: true, DisplayState: {Properties: {conditional: "true", facing: "down"}, Name: "minecraft:command_block"},DisplayOffset:10,Passengers:[{id:"slime",Tags:["20w14s.custom", "20w14s.skylinerw.slime"],Size:2,AbsorptionAmount:100f,Attributes:[{Name:"generic.maxHealth",Base:100d}],Health:100f,DeathTime:19s,CustomName:'{"text":"Skylinerw"}',Silent:1b,ActiveEffects:[{Id:14b,Duration:2147483647,ShowParticles:false}]}]}]}
