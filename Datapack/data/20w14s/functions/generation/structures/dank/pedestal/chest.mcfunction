#> 20w14s:generation/structures/dank/pedestal/chest
...
execute if score $rng.f2e86487f3df temp matches 0..6 run function 20w14s:generation/structures/dank/pedestal/chest/safe
execute if score $rng.f2e86487f3df temp matches 7 run function 20w14s:generation/structures/dank/pedestal/chest/trap
