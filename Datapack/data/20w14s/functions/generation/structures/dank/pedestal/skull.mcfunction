#> 20w14s:generation/structures/dank/pedestal/skull
...
execute if score $rng.40d5a91bd863 temp matches 0..19 run function 20w14s:generation/structures/dank/pedestal/skull/skeleton
execute if score $rng.40d5a91bd863 temp matches 20..27 run function 20w14s:generation/structures/dank/pedestal/skull/zombie
execute if score $rng.40d5a91bd863 temp matches 28..30 run function 20w14s:generation/structures/dank/pedestal/skull/creeper
execute if score $rng.40d5a91bd863 temp matches 31 run function 20w14s:generation/structures/dank/pedestal/skull/wither
