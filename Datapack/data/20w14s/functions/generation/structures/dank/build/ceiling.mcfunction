...
execute if score $rng.483692383f93 temp matches 0 run setblock ~ ~-1 ~ minecraft:lantern[hanging=true]
execute if score $rng.483692383f93 temp matches 1 run fill ~ ~-1 ~ ~ ~-1 ~ minecraft:iron_bars
execute if score $rng.483692383f93 temp matches 1 run setblock ~ ~-2 ~ minecraft:lantern[hanging=true]
execute if score $rng.483692383f93 temp matches 2 run fill ~ ~-1 ~ ~ ~-2 ~ minecraft:iron_bars
execute if score $rng.483692383f93 temp matches 2 run setblock ~ ~-3 ~ minecraft:lantern[hanging=true]
execute if score $rng.483692383f93 temp matches 3 run fill ~ ~-1 ~ ~ ~-3 ~ minecraft:iron_bars
execute if score $rng.483692383f93 temp matches 3 run setblock ~ ~-4 ~ minecraft:lantern[hanging=true]
