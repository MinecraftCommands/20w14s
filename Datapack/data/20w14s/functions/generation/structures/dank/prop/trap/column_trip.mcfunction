#> 20w14s:generation/structures/dank/prop/trap/column_trip
...
execute if score $rng.068cd737bcfa temp matches 0 run function 20w14s:generation/structures/dank/prop/trap/column_trip/set
