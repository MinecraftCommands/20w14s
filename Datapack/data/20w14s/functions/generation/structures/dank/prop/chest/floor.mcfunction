...
execute if score $rng.c82da5ae0ff7 temp matches 0..5 run function 20w14s:generation/structures/dank/prop/chest/_set/common
execute if score $rng.c82da5ae0ff7 temp matches 6..8 run function 20w14s:generation/structures/dank/prop/chest/_set/uncommon
execute if score $rng.c82da5ae0ff7 temp matches 9 run function 20w14s:generation/structures/dank/prop/chest/_set/rare
execute if score $rng.c82da5ae0ff7 temp matches 10 run function 20w14s:generation/structures/dank/prop/chest/_set/trap
