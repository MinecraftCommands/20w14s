...
execute if score $rng.5f1f55fd152d temp matches 0..11 run function 20w14s:generation/structures/dank/prop/chest/_set/common
execute if score $rng.5f1f55fd152d temp matches 12..17 run function 20w14s:generation/structures/dank/prop/chest/_set/uncommon
execute if score $rng.5f1f55fd152d temp matches 18..19 run function 20w14s:generation/structures/dank/prop/chest/_set/rare
