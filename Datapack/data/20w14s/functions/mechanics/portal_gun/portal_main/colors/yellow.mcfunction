...
execute as @a if score @s 20w14s.id = checked_portal_id 20w14s.prtl_main run scoreboard players operation checked_portal_count 20w14s.prtl_main = @s 20w14s.prtl_ypct
execute if score @s 20w14s.prtl_ct < checked_portal_count 20w14s.prtl_main run function 20w14s:mechanics/portal_gun/remove_portal/auto_remove_yellow
...
execute unless score on_blocks 20w14s.prtl_main matches 3 run function 20w14s:mechanics/portal_gun/remove_portal/auto_remove_yellow
...
execute if score mod 20w14s.prtl_main matches 0 run function 20w14s:mechanics/portal_gun/portal_main/ring/yellow