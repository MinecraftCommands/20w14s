...
execute as @e[type=area_effect_cloud,name=20w14s.portal_main,tag=20w14s.portal_main,tag=20w14s.blue_portal_main] at @s if score @s 20w14s.prtl_id = removal_id 20w14s.prtl_gun run function 20w14s:mechanics/portal_gun/remove_portal/structure/decode_blue_portal_direction
