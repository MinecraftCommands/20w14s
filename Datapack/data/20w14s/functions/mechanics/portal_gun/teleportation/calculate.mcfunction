...
scoreboard players set portal_out_direction 20w14s.prtl_tp -1
execute if score portal_out_color 20w14s.prtl_tp matches 0 as @e[type=area_effect_cloud,name=20w14s.portal_out,tag=20w14s.portal_out,tag=20w14s.blue_portal] if score @s 20w14s.prtl_id = portal_in_id 20w14s.prtl_tp run function 20w14s:mechanics/portal_gun/teleportation/get_out_direction
execute if score portal_out_color 20w14s.prtl_tp matches 1 as @e[type=area_effect_cloud,name=20w14s.portal_out,tag=20w14s.portal_out,tag=20w14s.orange_portal] if score @s 20w14s.prtl_id = portal_in_id 20w14s.prtl_tp run function 20w14s:mechanics/portal_gun/teleportation/get_out_direction
execute if score portal_out_color 20w14s.prtl_tp matches 2 as @e[type=area_effect_cloud,name=20w14s.portal_out,tag=20w14s.portal_out,tag=20w14s.red_portal] if score @s 20w14s.prtl_id = portal_in_id 20w14s.prtl_tp run function 20w14s:mechanics/portal_gun/teleportation/get_out_direction
execute if score portal_out_color 20w14s.prtl_tp matches 3 as @e[type=area_effect_cloud,name=20w14s.portal_out,tag=20w14s.portal_out,tag=20w14s.yellow_portal] if score @s 20w14s.prtl_id = portal_in_id 20w14s.prtl_tp run function 20w14s:mechanics/portal_gun/teleportation/get_out_direction
execute if score portal_out_color 20w14s.prtl_tp matches 4 as @e[type=area_effect_cloud,name=20w14s.portal_out,tag=20w14s.portal_out,tag=20w14s.light_blue_portal] if score @s 20w14s.prtl_id = portal_in_id 20w14s.prtl_tp run function 20w14s:mechanics/portal_gun/teleportation/get_out_direction
execute if score portal_out_color 20w14s.prtl_tp matches 5 as @e[type=area_effect_cloud,name=20w14s.portal_out,tag=20w14s.portal_out,tag=20w14s.purple_portal] if score @s 20w14s.prtl_id = portal_in_id 20w14s.prtl_tp run function 20w14s:mechanics/portal_gun/teleportation/get_out_direction
