...
execute if score valid_portal 20w14s.prtl_gun matches 1 if score portal_color 20w14s.prtl_gun matches 0 run function 20w14s:mechanics/portal_gun/create_new_portal/place_blue_portal_main
execute if score valid_portal 20w14s.prtl_gun matches 1 if score portal_color 20w14s.prtl_gun matches 1 run function 20w14s:mechanics/portal_gun/create_new_portal/place_orange_portal_main
